			...
			<div className="about-us-inner">
				...
				<section className="section">
					...
					<p style={{ maxWidth: "1000px", marginLeft: "auto" }}>
						...
						Odpovědnost — ke klientům, k termínům, ke kvalitě. Slovo dané je pro
						nás závazek. Flexibilita — každý projekt je jiný. Umíme se
						přizpůsobit požadavkům, situaci na trhu i neočekávaným výzvám.
						Kreativita — hledáme nejlepší řešení, ne to nejjednodušší. Ať jde o
						architektonický návrh nebo způsob financování projektu. Od roku 2013
						jsme dokázali, že tyto hodnoty a úspěšná realizace nejsou v rozporu.
						A to je základ důvěry, na které stavíme naše vztahy s klienty,
						investory i partnery.
					</p>
				</section>
				<section className="section">
