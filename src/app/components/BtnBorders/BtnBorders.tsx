...
const BtnBorders = () => {
	useEffect(() => {
		const borderTop = document.querySelectorAll(
			".btn-border-top",
		) as NodeListOf<HTMLDivElement>;
		const borderRight = document.querySelectorAll(
			".btn-border-right",
		) as NodeListOf<HTMLDivElement>;
		const borderBottom = document.querySelectorAll(
			".btn-border-bottom",
		) as NodeListOf<HTMLDivElement>;
		const borderLeft = document.querySelectorAll(
			".btn-border-left",
		) as NodeListOf<HTMLDivElement>;
